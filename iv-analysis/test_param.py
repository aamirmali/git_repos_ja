...
#        self.filtgain=2048.
        ...
        self.Rfb=np.array([2100.,2100.,2100.,2100.,2100.,2100.,2100.,2100.,2100.])
        self.db_bits=15
        ...
        self.PRn_low=np.array([0.5,0.3,0.3,0.3,0.3,0.3,0.3,0.3])
        self.PRn_high=np.array([0.8,0.6,0.6,0.6,0.6,0.6,0.6,0.6])
